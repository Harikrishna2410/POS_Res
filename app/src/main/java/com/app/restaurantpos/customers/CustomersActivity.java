...
//        getSupportActionBar().setTitle(R.string.all_customer);
        ...
        back_btn = findViewById(R.id.customer_screen_new_design_iv_back_btn);
        report_btn = findViewById(R.id.customer_screen_new_design_iv_reports);
        ...
        report_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CustomersActivity.this, ReportActivity.class));
            }
        });
