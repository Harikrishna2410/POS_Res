...
//        getSupportActionBar().setTitle(R.string.add_customer);
        ...
        back_btn = findViewById(R.id.add_customer_screen_new_design_iv_back_btn);
        report_btn = findViewById(R.id.add_customer_screen_new_design_iv_reports);
        ...
        report_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddCustomersActivity.this, ReportActivity.class));
