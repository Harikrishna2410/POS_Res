...
import com.app.restaurantpos.adapter.HomeScreenRvAdapter;
...
public class HomeActivity extends BaseActivity {
  ...
  RecyclerView rv;
  ImageView btn_aboutUs,btn_Logout;
...
//        getSupportActionBar().setTitle(R.string.app_name);
    ...
    rv = findViewById(R.id.home_screen_new_design_rv);
    btn_aboutUs = findViewById(R.id.home_screen_new_design_iv_about_us);
    btn_Logout = findViewById(R.id.home_screen_new_design_iv_logout);

    txtShopName = findViewById(R.id.home_screen_new_design_txt_shopname);

    sp = getSharedPreferences(Constant.SHARED_PREF_NAME, Context.MODE_PRIVATE);
    editor = sp.edit();
    userType = sp.getString(Constant.SP_USER_TYPE, "");

    HomeScreenRvAdapter adapter;

    List<HomeScreenRvModel> data = new ArrayList<>();
    data.add(new HomeScreenRvModel("Customers", R.mipmap.customer_services_png));
    data.add(new HomeScreenRvModel("Suppliers", R.mipmap.courier));
    data.add(new HomeScreenRvModel("Food Items", R.mipmap.food_serving));
    data.add(new HomeScreenRvModel("POS", R.mipmap.pos_terminal));
    data.add(new HomeScreenRvModel("Expense", R.mipmap.accounting));
    data.add(new HomeScreenRvModel("All Orders", R.mipmap.order_food));
    data.add(new HomeScreenRvModel("Reposts", R.mipmap.report));
    data.add(new HomeScreenRvModel("Settings", R.mipmap.settings));

    GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
    rv.setLayoutManager(gridLayoutManager);
    adapter = new HomeScreenRvAdapter(this, data, userType);
