...
public class PosActivity extends BaseActivity {
    ...
    TextView txtNoProducts,txt_cart_count;

    ImageView imgNoProduct,imgScanner,back_btn,cart_btn;
...
*/
        cart_btn = findViewById(R.id.pos_activity_new_design_iv_cart);
        back_btn = findViewById(R.id.pos_activity_new_design_iv_back_btn);
        txt_cart_count = findViewById(R.id.pos_activity_new_design_iv_cart_count);
        ...
        cart_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PosActivity.this,ProductCart.class));
            }
        });
