...
public class SuppliersActivity extends BaseActivity {
    ...
    ImageView imgNoProduct,back_btn,report_btn;
    EditText etxtSearch;
...
//        getSupportActionBar().setTitle(R.string.all_suppliers);
        back_btn = findViewById(R.id.suppliers_screen_new_design_iv_back_btn);
        report_btn = findViewById(R.id.suppliers_screen_new_design_iv_reports);
        ...
        report_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(SuppliersActivity.this, ReportActivity.class));
            }
        });
