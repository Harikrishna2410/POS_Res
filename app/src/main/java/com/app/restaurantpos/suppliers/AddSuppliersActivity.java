...
public class AddSuppliersActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getSupportActionBar().setHomeButtonEnabled(true); //for back button
        ...
        back_btn = findViewById(R.id.add_supplier_new_design_iv_back_btn);
        report_btn = findViewById(R.id.add_supplier_new_design_iv_reports);
        ...
        report_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AddSuppliersActivity.this, ReportActivity.class));
            }
        });
